...
import { change_profile } from './../actions/profileActions.js';
...
class Profile extends React.Component {
    ...
    componentDidMount(){
        ...
        .then(body => body.json())
        .then(json => this.props.change_profile(json.name, json.desc))
    }

    render() {
        return <>
            <h1>Profile</h1>
            <div>Hello: <b>{this.state.profile.name}</b></div>
            <div>
...
const mapDispatchToProps = dispatch => bindActionCreators({ change_profile }, dispatch);
